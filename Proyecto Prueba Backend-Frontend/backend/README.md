...
instalar el docke en backend:
winget --version
winget search Docker.DockerDesktop
winget install Docker.DockerDesktop
wsl --update

1. Descubre los nombres reales de los serviciosEjecuta este comando en tu terminal para leer el archivo y listar los nombres exactos de los contenedores configurados: "Select-String -Path .\docker-compose.yml -Pattern '^\s{2}[a-zA-Z0-9_-]+:'"
